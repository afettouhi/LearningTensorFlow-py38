...
with tf.compat.v1.variable_scope("lstm"):
    lstm_cell = tf.compat.v1.nn.rnn_cell.LSTMCell(hidden_layer_size,
                                                  forget_bias=1.0)
...
weights = {
    'linear_layer': tf.Variable(tf.compat.v1.truncated_normal([hidden_layer_size, num_classes],
                                                              mean=0, stddev=.01))
}
biases = {
    'linear_layer': tf.Variable(tf.compat.v1.truncated_normal([num_classes], mean=0, stddev=.01))
}
